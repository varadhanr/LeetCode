...
public class TreasueIsland2 {

	public static void main(String[] args) {

		char[][] islandMap = new char[][] { { 'S', 'o', 'o', 'S', 'S' }, { 'D', 'o', 'D', 'o', 'D' },
				{ 'o', 'o', 'o', 'o', 'X' }, { 'X', 'D', 'D', 'D', 'o' } };

		System.out.print(new TreasueIsland2().findDestinationInIsland(islandMap));
	...
	public int findDestinationInIsland(char[][] islandMap) {
		...
		for (int i = 0; i < r; i++) {
			for (int j = 0; j < c; j++) {
				if (islandMap[i][j] == 'S') {
					minSteps = Math.min(minSteps, this.bfs(islandMap, i, j));
				}
			}
		}
	...
	public int bfs(char[][] islandMap,int l,int m) {
